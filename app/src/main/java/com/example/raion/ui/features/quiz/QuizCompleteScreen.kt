...
fun QuizCompleteScreen(
    ...
    // Constraints
    val totalQuestions = 11
    val wrongAnswersCount = totalQuestions - correctAnswersCount
    val xpEarned = correctAnswersCount * 5
    val coinsEarned = correctAnswersCount * 15
    val isPassed = correctAnswersCount >= 6
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            // Mascot Image
            Image(
                painter = painterResource(id = R.drawable.dinoquizcomplete),
                ...
                Row(
                    ...
                    Surface(
                        ...
                        Row(
                            ...
                            // Coin Icon representation (we reuse an outline circle or similar if custom asset not provided)
                            Box(
                                modifier = Modifier
                                    .size(18.dp)
                    ...
                    Surface(
                        modifier = Modifier.weight(1f),
                        shape = RoundedCornerShape(8.dp),
                        color = if (isPassed) Color(0xFFFCEAED) else Color(0xFFF5F5F5), // Light orange/reddish if passed
                        border = BorderStroke(1.dp, if (isPassed) Color(0xFFD28258) else Color.Gray) // Orange border if passed
                    ) {
                        Text(
